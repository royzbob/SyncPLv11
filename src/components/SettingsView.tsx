...
export default function SettingsView({
  ...
  const handleCheckForUpdates = async () => {
    ...
    try {
      ...
      // CrabNebula returns HTTP 204 (or empty JSON) when there is no newer version published than current v1.0.11
      if (
        ...
        <div className="space-y-6">
          ...
          <div className="glass-panel p-5 rounded space-y-4 border border-[#2A2D31] bg-[#1E2023]/45">
            ...
            <div className="flex items-center justify-between px-3.5 py-2.5 bg-[#121417]/60 border border-[#2A2D31]/50 rounded-lg">
              ...
              <span className="text-xs font-mono font-bold text-indigo-400 bg-indigo-500/10 border border-indigo-500/20 px-2.5 py-1 rounded">v1.0.11 (Desktop)</span>
            </div>
            ...
            {updateState.status === "up-to-date" && (
              <div className="p-3.5 bg-emerald-950/30 border border-emerald-500/30 rounded-xl flex items-center gap-3">
                ...
                <div className="text-xs">
                  ...
                  <p className="text-emerald-400/80 text-[11px] mt-0.5">You are currently running version v1.0.11.</p>
                </div>
              </div>
            )}
